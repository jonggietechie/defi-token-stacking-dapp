...
contract TokenStaking is Ownable, ReentrancyGuard, Initializable{
    ...
    uint256 _totalStakedTokens; // start date for program
    ...
    uint256 _apyRate; //APY
    
    uint256 public constant PERCENTAGE_DENOMINATOR = 10000;
    uint256 public constant APY_RATE_CHANGE_THRESHOLD = 10;

    mapping(address => User) private _users; // User address => User
    ...
    function _TokenStaking_init_unchained(
        ...
        require(stakeStartDate_ < stakeEndDate_,"TokenStaking: start data must be less than end date");
    ...
    /**
    * @notice This function is used to get the minimum stacking amount
     */
    function getMinimumStackingAmount() external view returns (uint256){
    ...
    * @notice This function is used to get the maximum staking token limit for the program
     */
    function getMaxStackingTokenLimit() external view returns (uint256){
    ...
    * @notice This function is used to get the staking end date for program
    ...
    /**
    * @notice This function is used to get the total no of toekns that are staked
     */
    ...
    *@param amount the amount to withdraw
    ...
    /**
    *@notice This function is used to take tokens
    ...
    *@notice This function is used to claim user's rewards
    ...
    function claimRewards() external nonReentrant whenTreasuryHasBalance(_users[msg.sender].rewardAmount){
        ...
        require(rewardAmount >0, "TokenStaking: noreward to claim");
    ...
    *@param _user Address of the user
    *@return Estimated rewards for the users
     */
